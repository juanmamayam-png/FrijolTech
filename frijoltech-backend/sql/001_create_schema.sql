...
CREATE TABLE IF NOT EXISTS etapa_fenologica (
  ...
  campaña_id          INT REFERENCES campaña(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS registro_fenologico (
  ...
  campaña_id   INT REFERENCES campaña(id),
...
CREATE INDEX IF NOT EXISTS idx_campaña_lote ON campaña(lote_id);
CREATE INDEX IF NOT EXISTS idx_etapa_campaña ON etapa_fenologica(campaña_id);
CREATE INDEX IF NOT EXISTS idx_incidencia_campaña ON incidencia_fitosanitaria(campaña_id);
CREATE INDEX IF NOT EXISTS idx_bitacora_campaña ON bitacora_eventos(campaña_id);
