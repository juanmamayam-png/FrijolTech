...
test('CP-10: plagaId no numérico → 422', async () => {
  ...
  const res = await request(app)
    ...
    .send({
      fecha: '2026-05-10',
      severidad: 'alta',
      observaciones: 'Observaciones con suficiente longitud para pasar validación.',
  ...
  observaciones = 'plagaId no numérico rechazado con 422 correctamente.';
});
...
afterAll(() => {
  guardarResultado({
    id: 'CP-10', nombre: 'Validación incidencia — plaga inválida', rf: 'RF-11', tipo: 'Validación',
