/**
 * CP-06: Campana ICA Cerinza vs Cargamanto (RF-05 — Verificación Factory Method)
...
beforeAll(() => {
  mockCampanaCrear.mockResolvedValue({
    id: 2, ...DATOS_PRUEBA.campanaIcaCerinza, estado: 'activa', createdAt: new Date().toISOString(),
  });
...
afterAll(() => {
  guardarResultado({
    id: 'CP-06', nombre: 'Campana ICA Cerinza — diferenciacion Factory', rf: 'RF-05', tipo: 'Verificacion Factory',
