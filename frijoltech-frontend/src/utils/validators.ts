...
}).refine((d) => d.contraseña === d.confirmarContraseña, {
...
export const campañaSchema = z.object({
...
export const incidenciaSchema = z.object({
  campañaId: z.number({ invalid_type_error: 'Seleccione una campaña' }).positive(),
...
export type CampañaForm = z.infer<typeof campañaSchema>;
